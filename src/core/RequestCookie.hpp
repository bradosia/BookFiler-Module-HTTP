...
class CookieImpl : public Cookie
...
public:
  ...
  explicit CookieImpl(const std::map<std::string, std::string> &nvc);
  /// Creates a cookie from the given
...
// inlines
//
inline int CookieImpl::getVersion() const { return _version; }

inline const std::string &CookieImpl::getName() const { return _name; }

inline const std::string &CookieImpl::getValue() const { return _value; }

inline const std::string &CookieImpl::getComment() const { return _comment; }

inline const std::string &CookieImpl::getDomain() const { return _domain; }

inline const std::string &CookieImpl::getPath() const { return _path; }

inline const std::string &CookieImpl::getPriority() const { return _priority; }

inline bool CookieImpl::getSecure() const { return _secure; }

inline int CookieImpl::getMaxAge() const { return _maxAge; }

inline bool CookieImpl::getHttpOnly() const { return _httpOnly; }
